...
export const NEW_HOME = {
  ...
  seo: {
    ...
    description: '宅心驗屋提供台中新成屋驗屋服務，由專業驗屋公司執行窗框防水、排水坡度、熱顯像、用電等項目全面檢測，圖像化報告讓你與建商交涉有所依據。',
  ...
  intro: {
    ...
    items: [
      { icon: Droplets, label: '窗框防水不良', desc: '滲水風險，雨後易累積濕氣' },
      { icon: ArrowDownToLine, label: '地板排水坡度不足', desc: '積水隱患，淋浴區尤其常見' },
      ...
      { icon: AlignJustify, label: '天花板接縫脫落', desc: '輕隔間施工不良常見現象' },
    ],
  },
  compare: {
    label: '方案比較',
  ...
  faq: {
    title: '新成屋屋主常問的問題',
    items: [
      { q: '交屋前多久安排驗屋比較合適？', a: '建議在點交日前 1 至 2 週聯繫，讓我們有時間安排排程，也讓你在驗屋後有足夠時間與建商溝通修繕。如果交屋時程緊迫，請透過 LINE 說明，我們會盡力配合。' },
      { q: '驗屋後建商不願意修繕怎麼辦？', a: '宅心的報告提供明確的缺失位置、照片記錄與問題說明，是你與建商溝通最有力的書面依據。實際交涉由屋主主導，我們在報告說明階段會協助你理解哪些問題屬於建商應修繕範圍，讓你開口有底氣。' },
      { q: '新成屋驗屋會檢查哪些項目？', a: '主要包含：窗框密合與防水性、各區域排水坡度、熱顯像牆面與天花板溫差、電氣插座極性與接地、牆面批土與龜裂、天花板接縫，以及門窗開闔順暢度等項目。完整清單可於驗屋前確認。' },
      { q: '可以在點交當天才叫驗屋嗎？', a: '點交當天通常時間非常緊迫，且建商代表在場，現場壓力較大。建議提前安排驗屋，讓你在點交前已有完整的缺失清單，到點交當天只需確認修繕承諾即可，不需要臨時判斷。' },
    ],
  },
  cases: {
    label: '案例分享',
    ...
    items: [
      { tag: '窗框防水', meta: '台中西屯・新成屋', title: '窗框嵌縫不實，雨後滲水', desc: '熱顯像於窗周發現溫差異常，拆開後確認嵌縫不實，協助屋主於點交前要求建商重做。', img: asset('assets/cases/new-home-01.webp') },
      { tag: '排水坡度', meta: '台中北屯・新成屋', title: '浴室排水逆坡積水', desc: '倒水測試發現淋浴區排水逆坡，水往門口流。記錄完整後建商重新施作洩水坡。', img: asset('assets/cases/new-home-02.webp') },
...
export const USED_HOME = {
  ...
  intro: {
    ...
    items: [
      ...
      { icon: Cable, label: '排水坡度與管線狀態', desc: '老舊管線與排水不順的潛在問題' },
...
export const TOWNHOUSE = {
  ...
  intro: {
    ...
    items: [
      { icon: Mountain, label: '頂樓防水與排水', desc: '頂樓是滲水第一道關卡，需確認防水層與洩水坡度' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: '頂樓和外牆也會一起檢查嗎？', a: '會。頂樓防水、洩水坡度與外牆滲水是透天檢測的重點項目，我們會在可觀察與可安全到達的範圍內逐項確認，並以熱顯像輔助判斷。' },
