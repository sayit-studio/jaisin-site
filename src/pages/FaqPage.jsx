...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { q: '驗屋當天屋主需要在場嗎？', a: '建議在場，能直接了解發現與檢測方式；若無法到場，缺失重點也會完整記錄於報告中。' },
  ...
  },
  {
    ...
    items: [
      { q: '預約前需要準備哪些資料？', a: '請提供物件地址、房型、權狀坪數與建商提供的驗屋日期區間。若有客變圖或建商通知，也可一併提供。' },
      { q: '建議提前多久預約驗屋？', a: '建議分三個時間點安排：建商告知預計交屋季度時，提前 3 至 6 個月先詢問卡位；收到驗屋通知時，立即確認可安排區間；確定日期後，盡快完成排程。熱門交屋期常有大量住戶同時預約，越晚安排越不容易選到理想時段。' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: '交屋時程很趕，來得及安排嗎？', a: '驗屋日期主要依建商提供的驗屋區間安排，排程是固定的，沒有辦法臨時預約。請盡早提供建商給的驗屋區間，我們會協助在期間內排入。' },
      { q: '社區團購有專屬方案嗎？', a: '有。社區團購可統一協調排程，聯繫宅心官方 LINE 立刻幫您開團。' },
  ...
  },
  {
    ...
    items: [
      { q: '報告會在驗屋後多久提供？', a: '驗屋日隔天起算，五個工作天內提供 PDF 報告。' },
      { q: '驗屋報告可以拿來做什麼？', a: '報告完整保留缺失位置、照片與說明，可作為通知建商修繕及後續複驗的依據。' },
      { q: '宅心會代替屋主和建商交涉嗎？', a: '會。驗屋當天檢驗完畢後，驗屋師主管會帶著屋主與建商核對所有缺失，並協助屋主與建商溝通修繕標準與處理方式。' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: '除了驗屋，還提供哪些服務？', a: '另有全屋整裝服務，可依入住需求透過 LINE 詢問。' },
